...
const PresentazioneHome = () => {
  return (
    <div className="relative h-screen w-full flex items-end justify-start text-lg md:text-xl lg:text-2xl top-10">
      {/* Background Image */}
      ...
      {/* Text Content */}
      <div className="relative z-10 bg-black bg-opacity-80 shadow-2xl py-4 px-6 mx-4 mb-16 lg:mb-32 ml-16 rounded-br-3xl rounded-tl-3xl font-serif text-center text-white">
